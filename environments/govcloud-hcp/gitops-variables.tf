...
variable "gitops_cluster_ca_certificate" {
  type        = string
  default     = null
  description = "Optional PEM CA bundle for verified Kubernetes API TLS. Null uses system trust. Supply through a trusted channel; never disable certificate verification."
}
