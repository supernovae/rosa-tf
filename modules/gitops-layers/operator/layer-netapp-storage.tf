...
resource "kubernetes_secret_v1" "trident_backend_credentials" {
  count = var.enable_layer_netapp_storage && var.netapp_storage_config.backend_secret_name == "" ? 1 : 0
  metadata {
...
resource "kubectl_manifest" "trident_backend_san" {
  count             = var.enable_layer_netapp_storage && var.netapp_storage_config.san_enabled ? 1 : 0
...
resource "kubectl_manifest" "netapp_storage_class" {
  for_each          = var.enable_layer_netapp_storage ? local.netapp_storage_classes : {}
