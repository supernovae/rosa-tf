...
The 2.0 development branch pins RHCS `1.7.8-prerelease.2` and uses its native
...
See the exact [HCP](https://github.com/terraform-redhat/terraform-provider-rhcs/blob/v1.7.8-prerelease.2/docs/resources/hcp_default_ingress.md)
and [Classic](https://github.com/terraform-redhat/terraform-provider-rhcs/blob/v1.7.8-prerelease.2/docs/resources/default_ingress.md) schemas.
...
The [Red Hat Classic tutorial](https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws_classic_architecture/4/html/tutorials/cloud-experts-update-component-routes) documents the Secret namespace. Public HCP support guidance can lag the prerelease schema; treat HCP routes as development capability, not confirmed GA or GovCloud eligibility.
